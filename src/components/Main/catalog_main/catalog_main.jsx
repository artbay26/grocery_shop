...
const CatalogMain = () => {
    ...
    return (     
        <div className="main__catalog catalog">
            <div className="main__btnViewAll" onClick={toggleShowAll}><span>{showAll ? 'Collapse' : 'View'} All Products</span></div>
            <div className="catalog__container">   
                ...
                {
                    catalog.map(catalogItem =>
                        <div className={"catalog__wrapper " + (showAll ? "active" : "hidden")}  key={catalogItem.id}>
